...
;(function(factory) {
    ...
    Slick.prototype.getDotCount = function() {
        ...
        if (_.options.infinite === true) {
            ...
            pagerQty = 1 + Math.floor((_.slideCount - _.options.slidesToShow) / _.options.slidesToScroll);
        }else {
            while (breakPoint < _.slideCount) {
                ++pagerQty;
                breakPoint = counter + _.options.slidesToScroll;
    ...
    Slick.prototype.initADA = function() {
        var _ = this,
                numDotGroups = Math.floor(_.slideCount / _.options.slidesToShow),
    ...
    Slick.prototype.lazyLoad = function() {
        ...
        if (_.options.centerMode === true) {
            ...
            rangeEnd = Math.floor(rangeStart + _.options.slidesToShow);
